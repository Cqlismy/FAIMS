    ...
    ui(new Ui::frmInput)
{
    ...
    this->setWindowIcon(QIcon(":/images/mainwindow.png"));
    this->InitProperty();
    this->InitForm();
    this->ChangeStyle();
}
    ...
    if (event->type() == QEvent::MouseButtonPress) {
        ...
        if (mouseEvent->button() == Qt::LeftButton) {
            if (obj == ui->labCh0) {
                ...
                if (!obj->property("noinput").toBool() && objName != "MainWindow"
...
void frmInput::changeType(QString type)
{
    if (type == "max") {
        changeLetter(true);
//        ui->btnType->setText("Mode");
        ui->lab_Title->setText("  InputMode--Upper");
        ...
        changeLetter(false);
//        ui->btnType->setText("Mode");
        ui->lab_Title->setText("  InputMode--Lower");
        ui->btnOther12->setText("/");
        ui->btnOther14->setText(":");
        ui->btnOther17->setText(",");
        ui->btnOther18->setText("\\");
        ...
        changeLetter(false);
//        ui->btnType->setText("Mode");
        ui->lab_Title->setText("  InputMode--Chinese");
        ui->btnOther12->setText("");
        ui->btnOther14->setText("：");
        ui->btnOther17->setText("，");
        ui->btnOther18->setText("；");
